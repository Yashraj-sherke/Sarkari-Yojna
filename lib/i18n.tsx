...
export const translations = {
  hi: {
    ...
    detailBenefits: 'लाभ',
    detailEligibility: 'पात्रता',
    detailExclusions: 'अपवाद',
    detailProcess: 'आवेदन प्रक्रिया',
    detailDocuments: 'आवश्यक दस्तावेज़',
    detailFaqs: 'अधिकतर पूछे जाने वाले सवाल',
    detailSources: 'स्रोत और संदर्भ',
    detailFeedback: 'प्रतिपुष्टि',
    detailRelated: 'संबंधित योजनाएं',
    checkEligibility: 'पात्रता की जाँच करें',
    lastUpdate: 'अंतिम अपडेट:',
    nodalDept: 'नोडल विभाग:',
    officialSource: 'आधिकारिक स्रोत:',
    notAvailable: 'उपलब्ध नहीं',
    downloadForm: 'आवेदन पत्र डाउनलोड करें (PDF)',
    applyOnPortal: 'आधिकारिक पोर्टल पर आवेदन करें',
    noExclusions: 'कोई विशिष्ट अपवाद उपलब्ध नहीं है। कृपया विस्तृत जानकारी के लिए आधिकारिक स्रोत देखें।',
    defaultBenefit: 'लाभ सीधे लाभार्थी के आधार-लिंक DBT बैंक खाते में अंतरित किया जाता है।',
    online: 'ऑनलाइन',
    offline: 'ऑफ़लाइन',
    schemeNotFoundTitle: 'योजना नहीं मिली',
    waShareText: 'WhatsApp पर शेयर करें',
    waShareBannerMsg: 'यह जानकारी किसी ज़रूरतमंद के काम आ सकती है',
    waShareBannerSub: 'परिवार या दोस्तों को भेजें',
    waShareBtn: 'शेयर करें',
  ...
  en: {
    ...
    detailExclusions: 'Exclusions',
    detailProcess: 'Application Process',
    detailDocuments: 'Required Documents',
    detailFaqs: 'Frequently Asked Questions',
    detailSources: 'Sources & References',
    detailFeedback: 'Feedback',
    detailRelated: 'Related Schemes',
    checkEligibility: 'Check Eligibility',
    lastUpdate: 'Last Updated:',
    nodalDept: 'Nodal Department:',
    officialSource: 'Official Source:',
    notAvailable: 'Not Available',
    downloadForm: 'Download Application Form (PDF)',
    applyOnPortal: 'Apply on Official Portal',
    noExclusions: 'No specific exclusions available. Please check the official source for detailed information.',
    defaultBenefit: 'The benefit is transferred directly to the beneficiary\'s Aadhaar-linked DBT bank account.',
    online: 'Online',
    offline: 'Offline',
    schemeNotFoundTitle: 'Scheme Not Found',
    waShareText: 'Share on WhatsApp',
    waShareBannerMsg: 'This information could help someone in need',
    waShareBannerSub: 'Send to family or friends',
    waShareBtn: 'Share',
